<?php
// home.php - The main homepage for the portfolio website.
    ...
    <div class="content-wrapper">
        ...
        <section id="featured-project">
            ...
            <?php elseif ($featured_project): ?>
                <?php // Link the entire featured block to the project detail page ?>
                <a href="/project/<?php echo htmlspecialchars($featured_project['id']); ?>" class="featured-project-link">
                    <article>
                ...
                <p style="text-align: center; margin-top: 20px;">
                    <a href="/projects" style="font-weight: bold;">See All Projects &rarr;</a>
                </p>
